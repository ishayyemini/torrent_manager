...
function SearchTorrents({
    ...
    const onSearchFormSubmit = useCallback<FormEventHandler<HTMLFormElement>>(
        ...
        [logout, search, searchOptions, setSnack, toggleLoading],
    )
    ...
    const onApproveFormSubmit = useCallback<FormEventHandler<HTMLFormElement>>(
        ...
        [logout, metadata, selectedMagnet, setSnack, toggleLoading],
    )

    return torrents == undefined ? (
        <>
        ...
        <>
            ...
            <form onSubmit={onApproveFormSubmit}>
                ...
                <FormControlLabel
                    control={
                        <TextField
                            value={metadata.season?.toString() ?? '1'}
                            onChange={(e) =>
                                setMetadata({
                                    ...metadata,
                    ...
                    label={
                        <Box width={'auto'} margin={'0 10px 0 0'}>
                            Season
                        </Box>
                    }
                ...
                <FormControl>
                    <RadioGroup
                        ...
                        onChange={(e) =>
                            setMetadata((oldMetadata) => ({
                                ...oldMetadata,
                                type: e.target.value as Metadata['type'],
                            }))
                        }
                        row
                    >
